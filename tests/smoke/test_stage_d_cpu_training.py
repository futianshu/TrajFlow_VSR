...
class StageDCpuTrainingTest(unittest.TestCase):
    def test_one_step_stage_d_training_on_cpu(self):
        config = apply_overrides(
            load_config("configs/train/stage_d_distill.yaml"),
            [
        ...
        self.assertIn("distillation", result["history"][0])
        self.assertIn("teacher_target", result["history"][0])

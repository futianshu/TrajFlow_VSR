...
class StageCCpuTrainingTest(unittest.TestCase):
    def test_one_step_stage_c_training_on_cpu(self):
        config = apply_overrides(
            load_config("configs/train/stage_c_rectified_flow.yaml"),
            [
        ...
        self.assertIn("flow_matching", result["history"][0])
        self.assertIn("bridge_consistency", result["history"][0])
